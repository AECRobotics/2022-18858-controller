...
import org.firstinspires.ftc.teamcode.TeamUtils.AprilTagDetectionPipeline;
...
public class detectionWhiteTeam {
    OpenCvCamera camera;
    ...
    // UNITS ARE METERS
    double tagsize = 0.048; //in meters

    public detectionWhiteTeam(int cameraMonitorViewId, WebcamName webcamName) {
